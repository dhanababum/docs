...
<img
  ...
  alt="SuperMCP Architecture Diagram"
...
<AccordionGroup>
  <Accordion title="Dashboard & MCP Clients" icon="desktop">
    **User Interfaces**
  ...
  <Accordion title="Application Layer" icon="layer-group">
  ...
  <Accordion title="Postgres Connector" icon="database">
  ...
  <Accordion title="MySQL Connector" icon="database">
    **MySQL Integration**
  ...
  <Accordion title="Data Layer" icon="server">
    **Target Databases**
...
<CardGroup cols={2}>
  <Card title="Multi-Server Support" icon="servers">
  ...
  <Card title="MCP Protocol" icon="code-branch">
